...
public:
	...
	*/
	...
	void save();
private:
	class Directory_Entry //Step 5: Complete Programming Exercise 1.6 (page 113)  
	{
	public:
		Directory_Entry() { ; }
	...
	// Insert the definition of the Directory_Entry class here.
	// Private Functions
	...
	*/
	void remove_entry(int index); //Step 6: Complete Programming Exercise 1.7 (page 121) Code the remove_entry function.
	/** Creates a new array of directory entries with twice the
